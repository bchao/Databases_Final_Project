...
INSERT INTO Request VALUES
  ...
  (7,7,3,1,1,0,111111111,'open'),
  (8,8,3,1,1,1,111111111,'open'),
  (9,9,3,1,1,0,111111111,'open'),
  (10,10,3,1,0,0,111111111,'open'),
  (11,11,3,1,0,1,111111111,'open'),
  (12,12,3,1,0,1,111111111,'open'),
  (13,13,3,1,1,0,111111111,'open'),
  (14,14,3,1,1,1,111111111,'open'),
  (15,15,3,1,0,1,111111111,'open'),
  (16,16,3,1,1,1,111111111,'open'),
  (17,17,3,0,1,1,111111111,'open'),
  (18,18,3,0,1,1,111111111,'open'),
  (19,19,3,0,1,0,111111111,'open'),
  (20,20,3,0,1,1,111111111,'open'),
  (21,21,3,0,1,0,111111111,'open'),
  (22,22,3,0,1,0,111111111,'open'),
  (23,23,3,0,0,1,111111111,'open'),
  (24,24,3,0,0,1,111111111,'open'),
  (25,25,3,0,0,1,182375982375,'open'),
  (26,26,3,0,0,1,182375982375,'open'),
  (27,27,3,0,0,1,182375982375,'open'),
  (28,28,3,0,0,1,182375982375,'open'),
  (29,29,3,0,0,1,182375982375,'open'),
  (30,30,3,0,0,1,182375982375,'open'),
  (31,31,3,0,0,1,182375982375,'open');
